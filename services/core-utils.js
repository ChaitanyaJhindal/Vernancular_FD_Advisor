...
export function formatTenureTextForLang(lang, tenureMonths) {
  if (tenureMonths % 12 !== 0) {
    ...
    return `${tenureMonths} ${monthByLang[lang] || monthByLang.en}`;
  }
...
function buildUnsafeAdviceMessage(lang) {
  const msg = {
    ...
    bn: "আমি সেভিংস, বাজেটিং, FD, SIP, মিউচুয়াল ফান্ডের বেসিক, ব্যাংকিং এবং কাছাকাছি ব্যাংক বা ATM সম্পর্কে নিরাপদ সহায়তা করতে পারি। গ্যারান্টিযুক্ত লাভ বা অবৈধ আর্থিক পরামর্শ দিতে পারি না।",
    kn: "ನಾನು ಉಳಿತಾಯ, ಬಜೆಟಿಂಗ್, FD, SIP, ಮ್ಯೂಚುಯಲ್ ಫಂಡ್ ಮೂಲಭೂತಗಳು, ಬ್ಯಾಂಕಿಂಗ್ ಮತ್ತು ಸಮೀಪದ ಬ್ಯಾಂಕ್ ಅಥವಾ ATM ಬಗ್ಗೆ ಸುರಕ್ಷಿತ ಮಾರ್ಗದರ್ಶನ ನೀಡಬಹುದು. ಖಚಿತ ಲಾಭ ಅಥವಾ ಅಕ್ರಮ ಹಣಕಾಸು ಸಲಹೆ ನೀಡಲು ಸಾಧ್ಯವಿಲ್ಲ.",
    ml: "സേവിംഗ്, ബജറ്റിംഗ്, FD, SIP, മ്യൂച്വൽ ഫണ്ട് അടിസ്ഥാനങ്ങൾ, ബാങ്കിംഗ്, സമീപ ബാങ്ക്/ATM തുടങ്ങിയ സുരക്ഷിത വിഷയങ്ങളിൽ ഞാൻ സഹായിക്കാം. ഉറപ്പായ ലാഭമോ നിയമവിരുദ്ധ സാമ്പത്തിക നിർദേശങ്ങളോ നൽകാൻ കഴിയില്ല.",
    mr: "मी बचत, बजेटिंग, FD, SIP, म्युच्युअल फंडची मूलभूत माहिती, बँकिंग आणि जवळचे बँक किंवा ATM याबाबत सुरक्षित मार्गदर्शन देऊ शकतो. हमखास नफा किंवा बेकायदेशीर आर्थिक सल्ला देऊ शकत नाही.",
    od: "ମୁଁ ସେଭିଂସ୍, ବଜେଟିଂ, FD, SIP, ମ୍ୟୁଚୁଅଲ୍ ଫଣ୍ଡର ମୂଳ ତଥ୍ୟ, ବ୍ୟାଙ୍କିଂ ଏବଂ ନିକଟସ୍ଥ ବ୍ୟାଙ୍କ କିମ୍ବା ATM ବିଷୟରେ ସୁରକ୍ଷିତ ସହାୟତା କରିପାରିବି। ନିଶ୍ଚିତ ଲାଭ କିମ୍ବା ଅବୈଧ ଆର୍ଥିକ ପରାମର୍ଶ ଦେଇପାରିବି ନାହିଁ।",
    pa: "ਮੈਂ ਬਚਤ, ਬਜਟਿੰਗ, FD, SIP, ਮਿਊਚੁਅਲ ਫੰਡ ਬੇਸਿਕਸ, ਬੈਂਕਿੰਗ ਅਤੇ ਨੇੜਲੇ ਬੈਂਕ ਜਾਂ ATM ਬਾਰੇ ਸੁਰੱਖਿਅਤ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ। ਮੈਂ ਗਾਰੰਟੀਸ਼ੁਦਾ ਮੁਨਾਫ਼ੇ ਜਾਂ ਗੈਰਕਾਨੂੰਨੀ ਵਿੱਤੀ ਸਲਾਹ ਨਹੀਂ ਦੇ ਸਕਦਾ।",
    te: "సేవింగ్స్, బడ్జెటింగ్, FD, SIP, మ్యూచువల్ ఫండ్ మౌలికాలు, బ్యాంకింగ్, సమీప బ్యాంకులు లేదా ATMలపై సురక్షిత మార్గదర్శనం ఇవ్వగలను. హామీ లాభాలు లేదా చట్టవిరుద్ధ ఆర్థిక సూచనలు ఇవ్వలేను."
  };
...
export function formatBanksMessage(lang, banks = [], radiusKm = null) {
  ...
  const byLang = {
    ...
    bn: {
      intro: `এখানে ${banks.length}টি কাছাকাছি ব্যাংক বা ATM পাওয়া গেছে${radiusText ? ` ${radiusText} কিমির মধ্যে` : ""}:`,
      empty: "এখন কাছাকাছি ব্যাংকের তথ্য পাওয়া যায়নি। পরে আবার চেষ্টা করুন।"
    },
    kn: {
      intro: `ಇಲ್ಲಿ ${banks.length} ಸಮೀಪದ ಬ್ಯಾಂಕ್ ಅಥವಾ ATM ಕಂಡುಬಂದಿವೆ${radiusText ? ` ${radiusText} ಕಿಮೀ ಒಳಗೆ` : ""}:`,
      empty: "ಈಗ ಸಮೀಪದ ಬ್ಯಾಂಕ್ ಮಾಹಿತಿ ಸಿಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ."
    },
    ml: {
      intro: `ഇവിടെ ${banks.length} സമീപ ബാങ്ക്/ATM ലഭിച്ചു${radiusText ? ` ${radiusText} കിമീ പരിധിക്കுள்` : ""}:`,
      empty: "ഇപ്പോൾ സമീപ ബാങ്ക് വിവരങ്ങൾ ലഭ്യമായില്ല. ദയവായി വീണ്ടും ശ്രമിക്കുക."
    },
    mr: {
      intro: `इथे ${banks.length} जवळचे बँक किंवा ATM सापडले${radiusText ? ` ${radiusText} किमीच्या आत` : ""}:`,
      empty: "सध्या जवळच्या बँकेची माहिती मिळाली नाही. कृपया पुन्हा प्रयत्न करा."
    },
    od: {
      intro: `ଏଠାରେ ${banks.length}ଟି ନିକଟସ୍ଥ ବ୍ୟାଙ୍କ କିମ୍ବା ATM ମିଳିଲା${radiusText ? ` ${radiusText} କିମି ମଧ୍ୟରେ` : ""}:`,
      empty: "ଏବେ ନିକଟସ୍ଥ ବ୍ୟାଙ୍କ ସୂଚନା ମିଳିଲା ନାହିଁ। ପୁନର୍ବାର ଚେଷ୍ଟା କରନ୍ତୁ।"
    },
    pa: {
      intro: `ਇੱਥੇ ${banks.length} ਨੇੜਲੇ ਬੈਂਕ ਜਾਂ ATM ਮਿਲੇ ਹਨ${radiusText ? ` ${radiusText} ਕਿਮੀ ਦੇ ਅੰਦਰ` : ""}:`,
      empty: "ਇਸ ਵੇਲੇ ਨੇੜਲੇ ਬੈਂਕ ਦੀ ਜਾਣਕਾਰੀ ਨਹੀਂ ਮਿਲੀ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।"
    },
    te: {
      intro: `ఇక్కడ ${banks.length} సమీప బ్యాంకులు లేదా ATMలు లభించాయి${radiusText ? ` ${radiusText} కి.మీ పరిధిలో` : ""}:`,
      empty: "ప్రస్తుతం సమీప బ్యాంక్ సమాచారం దొరకలేదు. దయచేసి మళ్లీ ప్రయత్నించండి."
    }
  };
...
export function buildFinancialReply(userText, lang) {
  ...
  const messages = {
    ...
    bn: {
      savings: "সহজ নিয়ম: সেভিংস = আয় - খরচ। মাসিক আয়ের কমপক্ষে ২০% সঞ্চয় করার চেষ্টা করুন। ৩ থেকে ৬ মাসের খরচের সমান জরুরি তহবিল রাখুন।",
      budget: "মাসিক বাজেটকে তিন ভাগে ভাগ করুন: প্রয়োজন, ইচ্ছা, সঞ্চয়। ৩০ দিন খরচ লিখে ১-২টি অপ্রয়োজনীয় খরচ কমিয়ে সঞ্চয়ে দিন।",
      invest: "শুরুর জন্য FD স্থিতিশীলতা দেয় এবং SIP দীর্ঘমেয়াদে কম্পাউন্ডিংয়ের সুবিধা দেয়। ছোট থেকে শুরু করুন, নিয়মিত থাকুন, ৬ মাসে একবার রিভিউ করুন।",
      bank: "ব্যাংকিং সংক্রান্ত অ্যাকাউন্ট বেসিক, FD ওপেনিং, KYC এবং ডিজিটাল সেফটি বিষয়ে সাহায্য করতে পারি। আপনার নির্দিষ্ট প্রশ্ন বলুন।",
      default: "আমি সেভিংস, বাজেটিং, FD, SIP, মিউচুয়াল ফান্ড বেসিকস, ব্যাংকিং এবং কাছাকাছি ব্যাংক বা ATM বিষয়ে সাহায্য করতে পারি। আপনার আয়-খরচ বললে সহজ পরিকল্পনা দেব।"
    },
    kn: {
      savings: "ಸರಳ ನಿಯಮ: ಉಳಿತಾಯ = ಆದಾಯ - ವೆಚ್ಚ. ತಿಂಗಳ ಆದಾಯದ ಕನಿಷ್ಠ 20% ಉಳಿಸಲು ಪ್ರಯತ್ನಿಸಿ. 3 ರಿಂದ 6 ತಿಂಗಳ ವೆಚ್ಚದಷ್ಟು ತುರ್ತು ನಿಧಿ ಇಡಿ.",
      budget: "ತಿಂಗಳ ಬಜೆಟ್ ಅನ್ನು ಅಗತ್ಯಗಳು, ಇಚ್ಛೆಗಳು, ಉಳಿತಾಯ ಎಂದು ಹಂಚಿ. 30 ದಿನ ವೆಚ್ಚ ದಾಖಲಿಸಿ, ನಂತರ 1 ಅಥವಾ 2 ಅನಾವಶ್ಯಕ ವೆಚ್ಚ ಕಡಿತ ಮಾಡಿ ಉಳಿತಾಯಕ್ಕೆ ಹಾಕಿ.",
      invest: "ಆರಂಭಿಕರಿಗೆ FD ಸ್ಥಿರತೆ ನೀಡುತ್ತದೆ ಮತ್ತು SIP ದೀರ್ಘಾವಧಿಯಲ್ಲಿ ಸಂಯೋಜಿತ ಬೆಳವಣಿಗೆಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ. ಚಿಕ್ಕ ಮೊತ್ತದಿಂದ ಆರಂಭಿಸಿ, ನಿಯಮಿತವಾಗಿರಿ, 6 ತಿಂಗಳಿಗೊಮ್ಮೆ ಪರಿಶೀಲಿಸಿ.",
      bank: "ಬ್ಯಾಂಕಿಂಗ್‌ನಲ್ಲಿ ಖಾತೆ ಮೂಲಭೂತಗಳು, FD ತೆರೆಯುವ ಹಂತಗಳು, KYC ಮತ್ತು ಡಿಜಿಟಲ್ ಸುರಕ್ಷತೆ ಬಗ್ಗೆ ಮಾರ್ಗದರ್ಶನ ನೀಡಬಹುದು. ನಿಮ್ಮ ಸ್ಪಷ್ಟ ಪ್ರಶ್ನೆಯನ್ನು ತಿಳಿಸಿ.",
      default: "ನಾನು ಉಳಿತಾಯ, ಬಜೆಟಿಂಗ್, FD, SIP, ಮ್ಯೂಚುವಲ್ ಫಂಡ್ ಮೂಲಭೂತಗಳು, ಬ್ಯಾಂಕಿಂಗ್ ಮತ್ತು ಸಮೀಪದ ಬ್ಯಾಂಕ್ ಅಥವಾ ATM ಬಗ್ಗೆ ಸಹಾಯ ಮಾಡಬಹುದು. ನಿಮ್ಮ ಆದಾಯ ಮತ್ತು ವೆಚ್ಚ ತಿಳಿಸಿದರೆ ಸರಳ ಯೋಜನೆ ಕೊಡುತ್ತೇನೆ."
    },
    ml: {
      savings: "ലളിത നിയമം: സേവിംഗ്സ് = വരുമാനം - ചെലവ്. മാസവരുമാനത്തിന്റെ കുറഞ്ഞത് 20% സംരക്ഷിക്കാൻ ശ്രമിക്കുക. 3 മുതൽ 6 മാസം വരെയുള്ള ചെലവിന് തുല്യമായ അടിയന്തര ഫണ്ട് കരുതുക.",
      budget: "മാസ ബജറ്റ് ആവശ്യങ്ങൾ, ആഗ്രഹങ്ങൾ, സംരക്ഷണം എന്നിങ്ങനെ വിഭജിക്കുക. 30 ദിവസം ചെലവ് ട്രാക്ക് ചെയ്ത് 1-2 അനാവശ്യ ചെലവുകൾ കുറച്ച് സംരക്ഷണത്തിലേക്ക് മാറ്റുക.",
      invest: "തുടക്കക്കാർക്ക് FD സ്ഥിരത നൽകും, SIP ദീർഘകാലത്തിൽ കംപൗണ്ടിംഗ് വളർച്ചയ്ക്ക് സഹായിക്കും. ചെറിയ തുകയിൽ ആരംഭിച്ച് സ്ഥിരത പാലിച്ച് 6 മാസത്തിലൊരിക്കൽ റിവ്യൂ ചെയ്യുക.",
      bank: "ബാങ്കിംഗ് സഹായമായി അക്കൗണ്ട് അടിസ്ഥാനങ്ങൾ, FD തുറക്കൽ ഘട്ടങ്ങൾ, KYC, ഡിജിറ്റൽ സുരക്ഷ എന്നിവയിൽ ഞാൻ സഹായിക്കാം. നിങ്ങളുടെ വ്യക്തമായ ചോദ്യം പറയൂ.",
      default: "സേവിംഗ്സ്, ബജറ്റിംഗ്, FD, SIP, മ്യൂച്വൽ ഫണ്ട് അടിസ്ഥാനങ്ങൾ, ബാങ്കിംഗ്, സമീപ ബാങ്ക് അല്ലെങ്കിൽ ATM എന്നിവയിൽ ഞാൻ സഹായിക്കാം. നിങ്ങളുടെ വരുമാനവും ചെലവും പറഞ്ഞാൽ ലളിതമായ പദ്ധതി നൽകാം."
    },
    mr: {
      savings: "सोपा नियम: बचत = उत्पन्न - खर्च. मासिक उत्पन्नातील किमान 20% बचत करण्याचा प्रयत्न करा. 3 ते 6 महिन्यांच्या खर्चाएवढा इमर्जन्सी फंड ठेवा.",
      budget: "मासिक बजेट गरजा, इच्छा आणि बचत अशा भागांत विभागा. 30 दिवस खर्च नोंदवा आणि 1-2 अनावश्यक खर्च कमी करून बचतीत वळवा.",
      invest: "सुरुवातीसाठी FD स्थिरता देते आणि SIP दीर्घकालीन कंपाउंडिंगमुळे वाढ देते. छोट्या रकमेने सुरुवात करा, नियमित राहा आणि दर 6 महिन्यांनी आढावा घ्या.",
      bank: "बँकिंगमध्ये खाते मूलतत्त्वे, FD उघडणे, KYC आणि डिजिटल सुरक्षितता याबाबत मी मदत करू शकतो. तुमचा नेमका प्रश्न सांगा.",
      default: "मी बचत, बजेटिंग, FD, SIP, म्युच्युअल फंड मूलतत्त्वे, बँकिंग आणि जवळचे बँक किंवा ATM याबाबत मदत करू शकतो. तुमचे उत्पन्न आणि खर्च सांगितल्यास सोपी योजना देतो."
    },
    od: {
      savings: "ସରଳ ନିୟମ: ସେଭିଂସ୍ = ଆୟ - ଖର୍ଚ୍ଚ। ପ୍ରତିମାସ ଆୟର କମରେ କମ 20% ସଞ୍ଚୟ କରନ୍ତୁ। 3 ରୁ 6 ମାସର ଖର୍ଚ୍ଚ ପରିମାଣର ଏକ ଜରୁରୀ ଧନରାଶି ରଖନ୍ତୁ।",
      budget: "ମାସିକ ବଜେଟକୁ ଆବଶ୍ୟକତା, ଇଚ୍ଛା ଏବଂ ସଞ୍ଚୟରେ ଭାଗ କରନ୍ତୁ। 30 ଦିନ ଖର୍ଚ୍ଚ ଲେଖନ୍ତୁ, ପରେ 1-2ଟି ଅନାବଶ୍ୟକ ଖର୍ଚ୍ଚ କମେଇ ସଞ୍ଚୟକୁ ଦିଅନ୍ତୁ।",
      invest: "ଆରମ୍ଭକାରୀଙ୍କ ପାଇଁ FD ସ୍ଥିରତା ଦେଇଥାଏ ଏବଂ SIP ଦୀର୍ଘକାଳୀନ କମ୍ପାଉଣ୍ଡିଂରେ ଉପକାର କରେ। ଛୋଟ ରାଶିରୁ ଆରମ୍ଭ କରନ୍ତୁ, ନିୟମିତ ରୁହନ୍ତୁ ଏବଂ ପ୍ରତି 6 ମାସରେ ସମୀକ୍ଷା କରନ୍ତୁ।",
      bank: "ବ୍ୟାଙ୍କିଂ ସହାୟତାରେ ଆକାଉଣ୍ଟ ମୂଳଭୂମିକା, FD ଖୋଲିବା ପଦକ୍ରମ, KYC ଓ ଡିଜିଟାଲ ସୁରକ୍ଷା ବିଷୟରେ ମୁଁ ସହାୟତା କରିପାରିବି। ଆପଣଙ୍କ ନିର୍ଦ୍ଦିଷ୍ଟ ପ୍ରଶ୍ନ କହନ୍ତୁ।",
      default: "ମୁଁ ସେଭିଂସ୍, ବଜେଟିଂ, FD, SIP, ମ୍ୟୁଚୁଅଲ୍ ଫଣ୍ଡ ବେସିକ୍ସ, ବ୍ୟାଙ୍କିଂ ଏବଂ ନିକଟସ୍ଥ ବ୍ୟାଙ୍କ କିମ୍ବା ATM ବିଷୟରେ ସହାୟତା କରିପାରିବି। ଆପଣଙ୍କ ଆୟ ଓ ଖର୍ଚ୍ଚ କହିଲେ ସରଳ ପ୍ଲାନ୍ ଦେବି।"
    },
    pa: {
      savings: "ਸਧਾਰਣ ਨਿਯਮ ਰੱਖੋ: ਬਚਤ = ਆਮਦਨ - ਖਰਚਾ। ਹਰ ਮਹੀਨੇ ਘੱਟੋ-ਘੱਟ 20% ਬਚਤ ਕਰਨ ਦੀ ਕੋਸ਼ਿਸ਼ ਕਰੋ। 3 ਤੋਂ 6 ਮਹੀਨਿਆਂ ਦੇ ਖਰਚੇ ਦੇ ਬਰਾਬਰ ਐਮਰਜੈਂਸੀ ਫੰਡ ਰੱਖੋ।",
      budget: "ਮਾਸਿਕ ਬਜਟ ਨੂੰ ਲੋੜਾਂ, ਇੱਛਾਵਾਂ ਅਤੇ ਬਚਤ ਵਿੱਚ ਵੰਡੋ। 30 ਦਿਨ ਖਰਚਾ ਟਰੈਕ ਕਰੋ, ਫਿਰ 1-2 ਗੈਰ-ਜ਼ਰੂਰੀ ਖਰਚੇ ਘਟਾ ਕੇ ਬਚਤ ਵਿੱਚ ਪਾਓ।",
      invest: "ਸ਼ੁਰੂਆਤ ਲਈ FD ਸਥਿਰਤਾ ਦਿੰਦਾ ਹੈ ਅਤੇ SIP ਲੰਬੇ ਸਮੇਂ ਵਿੱਚ ਕੰਪਾਊਂਡਿੰਗ ਨਾਲ ਵਾਧਾ ਕਰਦਾ ਹੈ। ਛੋਟੀ ਰਕਮ ਨਾਲ ਸ਼ੁਰੂ ਕਰੋ, ਨਿਯਮਿਤ ਰਹੋ, ਅਤੇ ਹਰ 6 ਮਹੀਨੇ ਬਾਅਦ ਸਮੀਖਿਆ ਕਰੋ।",
      bank: "ਬੈਂਕਿੰਗ ਲਈ ਮੈਂ ਅਕਾਊਂਟ ਬੇਸਿਕਸ, FD ਖੋਲ੍ਹਣ ਦੇ ਕਦਮ, KYC ਅਤੇ ਡਿਜ਼ਿਟਲ ਸੁਰੱਖਿਆ ਬਾਰੇ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ। ਆਪਣਾ ਸਪਸ਼ਟ ਸਵਾਲ ਦੱਸੋ।",
      default: "ਮੈਂ ਬਚਤ, ਬਜਟਿੰਗ, FD, SIP, ਮਿਊਚੁਅਲ ਫੰਡ ਬੇਸਿਕਸ, ਬੈਂਕਿੰਗ ਅਤੇ ਨੇੜਲੇ ਬੈਂਕ ਜਾਂ ATM ਬਾਰੇ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ। ਆਪਣੀ ਆਮਦਨ ਅਤੇ ਖਰਚਾ ਦੱਸੋ, ਮੈਂ ਸੌਖਾ ਪਲਾਨ ਦਿਆਂਗਾ।"
    },
    te: {
      savings: "సరళ నియమం: సేవింగ్స్ = ఆదాయం - ఖర్చులు. ప్రతి నెల ఆదాయంలో కనీసం 20% సేవ్ చేయడానికి ప్రయత్నించండి. 3 నుండి 6 నెలల ఖర్చులకు సరిపడే ఎమర్జెన్సీ ఫండ్ ఉంచండి.",
      budget: "నెలవారీ బడ్జెట్‌ను అవసరాలు, కోరికలు, సేవింగ్స్‌గా విభజించండి. 30 రోజుల ఖర్చులను నమోదు చేసి 1-2 అవసరం లేని ఖర్చులను తగ్గించి సేవింగ్స్‌కి మార్చండి.",
      invest: "ప్రారంభస్థాయికి FD స్థిరత్వం ఇస్తుంది, SIP దీర్ఘకాలంలో కాంపౌండింగ్ వృద్ధికి సహాయపడుతుంది. చిన్న మొత్తంతో ప్రారంభించి నియమితంగా పెట్టుబడి చేసి ప్రతి 6 నెలలకు సమీక్షించండి.",
      bank: "బ్యాంకింగ్‌లో అకౌంట్ మౌలికాలు, FD ఓపెనింగ్ దశలు, KYC, డిజిటల్ భద్రతపై నేను సహాయం చేయగలను. మీ స్పష్టమైన ప్రశ్న చెప్పండి.",
      default: "సేవింగ్స్, బడ్జెటింగ్, FD, SIP, మ్యూచువల్ ఫండ్ బేసిక్స్, బ్యాంకింగ్, సమీప బ్యాంకులు లేదా ATMలపై నేను సహాయం చేయగలను. మీ ఆదాయం, ఖర్చులు చెప్పండి, సరళ ప్రణాళిక ఇస్తాను."
    }
  };
